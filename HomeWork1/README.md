**И двете задачи трябва да имат функция, която демонстрира работата на всеки един от методите. Също така структурите трябва да са динамични, тоест да бъдат с динамична памет.**
